...
\begin{abstract}
Palabras separadas por comas que identifiquen el contenido del proyecto Ej: Dispositivo, control postural, servidor web, buscador de vuelos, android, agsda, asds, asddasf, asdfdfs, asdsdafas, asdfsdaf,asdf sadf. \ldots
\end{abstract}
...
\begin{abstract}
keywords separated by commas. Dispositivo, Control postural. (En inglés)
\end{abstract}
